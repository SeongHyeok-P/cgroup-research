...
VICTIM_LOG="imc_victim_${SIZE_MIB}_hog${COUNT}.log"
...
PERF_LOG="perf_imc_${SIZE_MIB}_hog${COUNT}.txt"

echo "[4] IMC perf 시작"


sudo perf stat -a \
    -e uncore_imc_0/unc_m_cas_count_rd/ \
    -e uncore_imc_0/unc_m_cas_count_wr/ \
    -e uncore_imc_1/unc_m_cas_count_rd/ \
    -e uncore_imc_1/unc_m_cas_count_wr/ \
    -- \
